...
def plot(B, epoch, fig=1, init=True, with_noise=False):
    if init:
...
##
doplot, auto, feed = True, False, True  # plot?, autonomous?, w/ feedback?
num_to_plot = 3
...
# task parameters
T = 45      # duration (in units of tau)
g_lims = (10, 25)
rand_tar = True
move_time = 10

# physics parameters
noise_scale = 0.25  # network output multiplicative noise scale
...
# final plot
if doplot:
    plot(num_to_plot, Nepochs, init=False, with_noise=True)
